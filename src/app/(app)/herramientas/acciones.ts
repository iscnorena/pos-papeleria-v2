...
// apaga su fila en `tool_settings`, y listo — el índice público de /kit lee esa
// misma tabla al armar la lista.
//
// Hay que revalidar TRES cosas, no solo el índice: la propia ruta pública de la
// herramienta (`/kit/rifas`, etc. — que también lee `tool_settings` para decidir si
